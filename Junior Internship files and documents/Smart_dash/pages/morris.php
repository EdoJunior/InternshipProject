...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">MM Guide</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Graph Information</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                ...
                foreach($widgets as $widget){
                    echo '<div id="'.$widget['id'].'"class="col-sm-6">';
    ...
    <script>
        ...
        {
            var widgetId = $(event.target).parentsUntil('.col-sm-4').parent().attr('id');
        ...
        function addClick(container,elementId)
        {
            ...
            if(!$('#'+elementId).hasClass('col-sm-4')) return;
